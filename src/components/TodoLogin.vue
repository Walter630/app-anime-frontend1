<template>
  <v-container
    ...
    "
  >
    <v-card class="login pa-6 rounded-xl ma-5" width="400" elevation="4">
      <v-card-title class="text-h4 text-center mb-4"
        ><img src="/LogoYokuso.png" alt=""
      /></v-card-title>
      ...
      <form @submit.prevent="login">
        ...
        <v-btn color="#6c63ff" block class="white--text" type="submit"> Acessar </v-btn>
